...
@section('body')
<header>
    <x-main-header title="List Categorie" />
</header>
...
<section class="my-5">
    <div class="p-4 w-full border border-gray-100 shadow rounded-lg">
        <div class="mb-5 flex justify-end">
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="block w-full sm:w-max text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                Create New
            </button>
        </div>
        ...
        @livewire("list-master-categories")
    </div>
</section>
@endsection